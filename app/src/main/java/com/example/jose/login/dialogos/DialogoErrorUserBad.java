...
public class DialogoErrorUserBad extends DialogFragment {

    String titulo;
    final static String TAG_ARG1 ="argumento1";
    public static DialogoErrorUserBad newInstance(String titulo){

        DialogoErrorUserBad dialogoConfirmacionDos = new DialogoErrorUserBad();
        Bundle b = new Bundle();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setMessage("Usuario erroneo");
