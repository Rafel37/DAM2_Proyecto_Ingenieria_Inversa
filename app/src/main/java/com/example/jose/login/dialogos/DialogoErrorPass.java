...
public class DialogoErrorPass extends DialogFragment {
    ...
    public static DialogoErrorPass newInstance(String titulo){

        DialogoErrorPass dialogoConfirmacionDos = new DialogoErrorPass();
        Bundle b = new Bundle();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setMessage("Introduzca la contraseña");
