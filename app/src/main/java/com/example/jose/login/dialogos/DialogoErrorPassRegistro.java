...
public class DialogoErrorPassRegistro extends DialogFragment {

    String titulo;
    final static String TAG_ARG1 ="argumento1";
    public static DialogoErrorPassRegistro newInstance(String titulo){

        DialogoErrorPassRegistro dialogoConfirmacionDos = new DialogoErrorPassRegistro();
        Bundle b = new Bundle();
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        builder.setMessage("Debe de poner la misma contraseña");
